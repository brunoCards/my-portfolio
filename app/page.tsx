        ...
        <main className='w-full flex flex-col gap-20 pt-[25vh]'>
          ...
          <section className='p-4 flex gap-3 rounded-md'>
            ...
            <p className='text-base text-justify'>
              Fullstack Developer with 3+ years of hands-on experience.
              Passionate about creating functional, scalable solutions that make
              a real impact. I’ve worked on over 15 projects—ranging from legacy
              systems to modern technologies—always focusing on quality,
              collaboration, and tangible results. Currently seeking remote
              opportunities (within Brazil or abroad) in companies that value
              continuous growth and clear career progression. If you’re looking
              for a committed fullstack dev who delivers clean code and real
              outcomes, let’s talk!
            </p>
          </section>
            ...
            <div className='flex flex-col gap-16'>
              <div className='flex flex-col gap-6'>
                ...
                <ul className='list-disc list-inside flex flex-col gap-4 text-justify font-light text-sm'>
                  ...
                  <li>
                    Worked on multiple projects, collaborating with peers to
